...
const MainContent: React.FC = () => {
  const { activeTab, setActiveTab, setIsAIModalOpen, setIsScannerModalOpen, setIsVoiceModalOpen, requireAuth, user } = useApp();
  ...
  return (
    <div className="min-h-screen flex flex-col text-white bg-transparent">
      ...
      <div className="fixed bottom-6 right-6 flex flex-col items-end gap-3 z-50">
        ...
        <button
          onClick={() => requireAuth(() => setIsVoiceModalOpen(true))}
          className="flex items-center gap-2 p-3.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-full shadow-2xl transition-all hover:pr-5 group cursor-pointer border border-indigo-400/40"
