...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  edgeSensitivity = 30,
  glowColor = '40 80 80',
  backgroundColor = 'transparent', // Modified default for glassmorphism
  borderRadius = 16, // Defaulted to standard 16px (xl)
  glowRadius = 40,
  glowIntensity = 1.0,
  coneSpread = 25,
  animated = false,
  colors = ['#10b981', '#3b82f6', '#8b5cf6'], // Modified to agri theme
  fillOpacity = 0.5,
  style = {}
}) => {
