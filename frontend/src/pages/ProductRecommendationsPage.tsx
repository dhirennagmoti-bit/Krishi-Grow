    ...
    <div className="space-y-6">
      ...
      <div className="bg-black/60 backdrop-blur-xl p-6 md:p-8 rounded-xl border border-white/10 shadow-md">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-amber-500/20 text-amber-300 border border-amber-500/30 flex items-center justify-center font-bold shadow-md shadow-amber-950/50">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold bg-amber-500/20 text-amber-300 border border-amber-500/30">
          ...
          <div className="flex items-center gap-3">
            <div className="px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-right">
              <span className="text-xs text-neutral-400 block">Covered Crops</span>
              <span className="text-sm font-bold text-emerald-400 font-mono">26 Crops</span>
            </div>
            <div className="px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-right">
              <span className="text-xs text-neutral-400 block">Avg Value Boost</span>
      ...
      <div className="space-y-6">
        {filteredGuides.length === 0 ? (
          <div className="bg-black/60 backdrop-blur-xl p-12 rounded-xl border border-white/10 text-center text-neutral-400">
          ...
          filteredGuides.map((guide) => (
            <div
              key={guide.id}
              className="bg-black/60 backdrop-blur-xl rounded-xl border border-white/10 shadow-md overflow-hidden hover:border-amber-500/30 transition-all group"
            >
              <div className="grid grid-cols-1 lg:grid-cols-12">
                ...
                <div className="lg:col-span-4 relative h-64 lg:h-auto min-h-[260px] overflow-hidden bg-neutral-900">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="px-3 py-1 rounded-full text-xs font-bold bg-black/80 backdrop-blur-md text-amber-300 border border-amber-500/30 shadow-md">
                      {guide.category}
                    </span>
                  </div>

                  {/* Profit Margin pill */}
                  <div className="absolute bottom-4 left-4 bg-emerald-950/90 backdrop-blur-md px-3.5 py-1.5 rounded-xl border border-emerald-500/40 text-left shadow-md">
                    <span className="text-xs text-neutral-400 block font-medium">Estimated Value Gain</span>
                ...
                <div className="lg:col-span-8 p-6 md:p-8 space-y-5">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 pb-4 border-b border-white/10">
                    ...
                    <div className="flex items-center gap-2">
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-red-600/90 hover:bg-red-600 text-white text-xs font-bold shadow-md shadow-red-950 transition-all border border-red-500/40 cursor-pointer"
                      >
                  ...
                  {/* Key Metrics Grid */}
                  <div className="grid grid-cols-3 gap-3 bg-white/5 p-3.5 rounded-xl border border-white/10 text-xs">
                    <div>
                      <span className="text-xs text-neutral-400 block">Market Demand</span>
                      <span className="font-bold text-emerald-400 font-mono">{guide.marketDemand}</span>
                    </div>
                    <div>
                      <span className="text-xs text-neutral-400 block">Capex Investment</span>
                      <span className="font-bold text-amber-300 font-mono">{guide.investmentLevel}</span>
                    </div>
                    <div>
                      <span className="text-xs text-neutral-400 block">Shelf Life Extension</span>
