    ...
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4">
        ...
        <div 
          ...
          className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 hover:border-emerald-500/40 transition-all cursor-pointer group shadow-md"
        >
          ...
          <span className="text-xs text-emerald-400 font-medium mt-1 block">{t('aggregatorDashboard.activeDistricts')}</span>
        </div>

        {/* KPI 2: Produce Collected Today */}
        <div className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 hover:border-cyan-500/40 transition-all shadow-md">
          <div className="flex items-center justify-between text-neutral-400 mb-2">
          ...
          <span className="text-xs text-cyan-400 font-medium mt-1 block">{t('aggregatorDashboard.acrossVehicleTrips')}</span>
        </div>

        {/* KPI 3: Total Warehouse Inventory */}
        <div 
          onClick={() => setActiveTab('aggregator-inventory-market')}
          className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 hover:border-blue-500/40 transition-all cursor-pointer group shadow-md"
        >
          <div className="flex items-center justify-between text-neutral-400 mb-2">
          ...
          <span className="text-xs text-blue-400 font-medium mt-1 block">{t('aggregatorDashboard.cropBatchesStored')}</span>
        </div>

        {/* KPI 4: Pending Pickups */}
        <div 
          onClick={() => setActiveTab('aggregator-collection')}
          className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 hover:border-amber-500/40 transition-all cursor-pointer group shadow-md"
        >
          <div className="flex items-center justify-between text-neutral-400 mb-2">
          ...
          <span className="text-xs text-amber-400 font-medium mt-1 block">{t('aggregatorDashboard.inTransitScheduled')}</span>
        </div>

        {/* KPI 5: Incoming / Outgoing Orders */}
        <div className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 hover:border-blue-500/40 transition-all shadow-md">
          <div className="flex items-center justify-between text-neutral-400 mb-2">
          ...
          <span className="text-xs text-blue-400 font-medium mt-1 block">{t('aggregatorDashboard.offersContracts')}</span>
        </div>

        {/* KPI 6: Today's Purchase Value */}
        <div className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 hover:border-rose-500/40 transition-all shadow-md">
          <div className="flex items-center justify-between text-neutral-400 mb-2">
          ...
          <span className="text-xs text-rose-400 font-medium mt-1 block">{t('aggregatorDashboard.farmerGateProcurement')}</span>
        </div>

        {/* KPI 7: Today's Sales Value */}
        <div className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 hover:border-emerald-500/40 transition-all shadow-md">
          <div className="flex items-center justify-between text-neutral-400 mb-2">
          ...
          <span className="text-xs text-emerald-300 font-medium mt-1 block">{t('aggregatorDashboard.vsYesterday')}</span>
        </div>

        {/* KPI 8: Pending Farmer Payments */}
        <div className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 hover:border-orange-500/40 transition-all shadow-md">
          <div className="flex items-center justify-between text-neutral-400 mb-2">
          ...
          <span className="text-xs text-orange-400 font-medium mt-1 block">{t('aggregatorDashboard.rtgsClearance')}</span>
        </div>

        {/* KPI 9: AI Demand Match Index */}
        <div className="p-5 rounded-xl bg-emerald-950/30 backdrop-blur-xl border border-emerald-500/30 hover:border-emerald-400 transition-all shadow-md">
          ...
          <span className="text-xs text-emerald-200 font-medium mt-1 block">{t('aggregatorDashboard.highProcessorDemand')}</span>
        </div>
            ...
            {collectionRequests.map((req) => (
              ...
              >
                ...
                <div className="text-left sm:text-right font-mono text-xs text-neutral-300 shrink-0">
                  ...
                  <div className="text-neutral-400 text-xs">{req.assignedDriver}</div>
                  <span className="text-xs text-amber-300 font-sans block mt-0.5">ETA: {req.eta}</span>
                </div>
              </div>
            ))}
          </div>
            ...
            {aggregatorInventory.map((item) => (
              ...
              >
                ...
                <div className="text-left sm:text-right font-mono text-xs text-neutral-300 shrink-0">
                  ...
                  <div className="text-xs text-neutral-400">{item.daysInStorage}{t('aggregatorDashboard.inStorage')}</div>
                  <span className="text-xs px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 font-bold block mt-1">
