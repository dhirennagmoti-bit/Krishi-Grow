      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        <div className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 shadow-md">
          <div className="flex items-center justify-between text-neutral-400 mb-2">
            <span className="text-xs font-semibold uppercase tracking-wider">{t('wholesalerDashboard.totalInventory')}</span>
          ...
          <span className="text-xs text-blue-400 font-medium mt-1 block">{t('wholesalerDashboard.inColdDryGodowns')}</span>
        </div>

        {/* KPI 2: Inventory Value */}
        <div className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 shadow-md">
          <div className="flex items-center justify-between text-neutral-400 mb-2">
            <span className="text-xs font-semibold uppercase tracking-wider">{t('wholesalerDashboard.inventoryValue')}</span>
          ...
          <span className="text-xs text-emerald-400 font-medium mt-1 block">{t('wholesalerDashboard.costValuationBasis')}</span>
        </div>

        {/* KPI 3: Today's Purchases */}
        <div className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 shadow-md">
          <div className="flex items-center justify-between text-neutral-400 mb-2">
            <span className="text-xs font-semibold uppercase tracking-wider">{t('wholesalerDashboard.todaysPurchases')}</span>
            <Store className="w-4 h-4 text-cyan-400" />
          </div>
          <div className="text-xl font-black text-cyan-400 font-mono">₹1,84,000</div>
          <span className="text-xs text-cyan-300 font-medium mt-1 block">{t('wholesalerDashboard.fromAggregatorLots')}</span>
        </div>

        {/* KPI 4: Today's Sales */}
        <div className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 shadow-md">
          <div className="flex items-center justify-between text-neutral-400 mb-2">
            <span className="text-xs font-semibold uppercase tracking-wider">{t('wholesalerDashboard.todaysSales')}</span>
            <TrendingUp className="w-4 h-4 text-emerald-400" />
          </div>
          <div className="text-xl font-black text-emerald-400 font-mono">₹2,08,750</div>
          <span className="text-xs text-emerald-300 font-medium mt-1 block">{t('wholesalerDashboard.dispatchedToRetail')}</span>
        </div>
        ...
        >
          <div className="flex items-center justify-between text-neutral-400 mb-2">
            <span className="text-xs font-semibold uppercase tracking-wider">{t('wholesalerDashboard.pendingShipments')}</span>
          ...
          <span className="text-xs text-amber-400 font-medium mt-1 block">{t('wholesalerDashboard.enrouteMumbaiPune')}</span>
        </div>

        {/* KPI 6: Institutional Customers */}
        <div 
          onClick={() => setActiveTab('wholesaler-customers')}
          className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 hover:border-blue-500/40 transition-all cursor-pointer shadow-md"
        >
          <div className="flex items-center justify-between text-neutral-400 mb-2">
            <span className="text-xs font-semibold uppercase tracking-wider">{t('wholesalerDashboard.b2bCustomers')}</span>
          ...
          <span className="text-xs text-blue-400 font-medium mt-1 block">{t('wholesalerDashboard.retailersHotelGroups')}</span>
        </div>

        {/* KPI 7: Cumulative Revenue */}
        <div className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 shadow-md">
          <div className="flex items-center justify-between text-neutral-400 mb-2">
            <span className="text-xs font-semibold uppercase tracking-wider">{t('wholesalerDashboard.totalSalesRev')}</span>
            <DollarSign className="w-4 h-4 text-emerald-400" />
          </div>
          <div className="text-xl font-black text-emerald-400 font-mono">₹{(totalRevenue / 100000).toFixed(2)} L</div>
          <span className="text-xs text-emerald-300 font-medium mt-1 block">{t('wholesalerDashboard.currentCycleVolume')}</span>
        </div>

        {/* KPI 8: Total Operations Cost */}
        <div className="p-5 rounded-xl bg-black/40 backdrop-blur-xl border border-white/10 shadow-md">
          <div className="flex items-center justify-between text-neutral-400 mb-2">
            <span className="text-xs font-semibold uppercase tracking-wider">{t('wholesalerDashboard.totalCOGSLogistics')}</span>
            <Clock className="w-4 h-4 text-rose-400" />
          </div>
          <div className="text-xl font-black text-white font-mono">₹{(totalCost / 100000).toFixed(2)} L</div>
          <span className="text-xs text-rose-400 font-medium mt-1 block">{t('wholesalerDashboard.purchTranspStorage')}</span>
        </div>

        {/* KPI 9: Net Profit */}
        <div className="p-5 rounded-xl bg-emerald-950/30 backdrop-blur-xl border border-emerald-500/30 shadow-md">
          <div className="flex items-center justify-between text-emerald-300 mb-2">
            <span className="text-xs font-semibold uppercase tracking-wider">{t('wholesalerDashboard.netRealizedProfit')}</span>
            <TrendingUp className="w-4 h-4 text-emerald-400" />
          </div>
          <div className="text-xl font-black text-emerald-400 font-mono">₹{totalNetProfit.toLocaleString()}</div>
          <span className="text-xs text-emerald-300 font-medium mt-1 block">{t('wholesalerDashboard.margin')} {avgProfitMargin}%</span>
        </div>

        {/* KPI 10: AI Arbitrage Optimizer */}
        <div className="p-5 rounded-xl bg-blue-950/30 backdrop-blur-xl border border-blue-500/30 shadow-md">
          <div className="flex items-center justify-between text-blue-300 mb-2">
            <span className="text-xs font-semibold uppercase tracking-wider">{t('wholesalerDashboard.aiMarginIndex')}</span>
            <Sparkles className="w-4 h-4 text-blue-400 animate-spin" />
          </div>
          <div className="text-xl font-black text-blue-300 font-mono">+14.6%</div>
          <span className="text-xs text-blue-200 font-medium mt-1 block">{t('wholesalerDashboard.topCropTomato')}</span>
        </div>
      ...
      <div className="p-6 md:p-8 rounded-xl bg-black/60 backdrop-blur-xl border border-white/10 shadow-xl space-y-6">
        ...
        <div className="space-y-4">
          {profitAnalytics.map((p, idx) => (
            <div
              key={idx}
              className="p-5 rounded-xl bg-white/5 border border-white/10 hover:border-emerald-500/30 transition-all space-y-3"
            >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 text-xs font-mono">
                <div className="p-2 rounded-xl bg-black/40 border border-white/5">
                  <span className="text-xs text-neutral-400 block font-sans">{t('wholesalerDashboard.purchaseCost')}</span>
                  <span className="text-white font-bold">₹{p.purchaseCost.toLocaleString()}</span>
                </div>
                <div className="p-2 rounded-xl bg-black/40 border border-white/5">
                  <span className="text-xs text-neutral-400 block font-sans">{t('wholesalerDashboard.transportLogistics')}</span>
                  <span className="text-neutral-300">₹{p.transportCost.toLocaleString()}</span>
                </div>
                <div className="p-2 rounded-xl bg-black/40 border border-white/5">
                  <span className="text-xs text-neutral-400 block font-sans">{t('wholesalerDashboard.coldDryStorage')}</span>
                  <span className="text-neutral-300">₹{p.storageCost.toLocaleString()}</span>
                </div>
                <div className="p-2 rounded-xl bg-black/40 border border-white/5">
                  <span className="text-xs text-neutral-400 block font-sans">{t('wholesalerDashboard.packhouseHandling')}</span>
                  <span className="text-neutral-300">₹{p.handlingCost.toLocaleString()}</span>
                </div>
                <div className="p-2 rounded-xl bg-black/40 border border-white/5">
                  <span className="text-xs text-neutral-400 block font-sans">{t('wholesalerDashboard.otherLevies')}</span>
