...
Provide helpful, clear, professional responses formatted with bullet points and bold highlights when appropriate. Keep answers concise, actionable, and encouraging for Indian farmers and buyers.`;
  ...
  return `**🌾 AgriAI Advisory:**\n\nThank you for asking! For **${userPrompt}**:\n\n• **Cultivation & Quality:** Ensure balanced NPK fertilization (120:60:60) with micronutrient foliar spray for optimal yield.\n• **Market Realization:** Monitor real-time mandi prices on our Dashboard before dispatching to mandis.\n• **Direct Sales:** You can list your harvested stock directly on Krishi Grow to connect with verified aggregators and food processors at 0% intermediary fee.`;
}
